...
\begin{frame}{Convex Problems in Statistics}
	...
	\BIT
		\item Least squares, ridge and lasso regression, non-negative least squares 
...
\begin{frame}{Domain Specific Languages for Convex Optimization}
	...
	\BIT
		...
		\item Slower than custom code, but extremely flexible, fast prototyping, etc
		\item TODO: CVXPY snippet
	\EIT
\end{frame}
...
\begin{frame}[fragile]{Non-Negative Least Squares}
	\BIT
...
\begin{frame}{Non-Negative Least Squares}
	%Change the title and legend to be consistent
	%Add plot before this with just true beta and least squares
	\vfill
	\begin{figure}
...
\begin{frame}{Direct Standardization}
	...
	\BIT
		...
		\item Expectations of features in $X$ are a known quantity $b \in \reals^m$
		\item Want to predict probability $p_i$ for each sample
	...
	\item $(p_i,y_i)$ is a guess of true distribution
	\EIT
\end{frame}
...
\begin{frame}{Results: Direct Standardization}
	TODO: Plot of CDF from original and skewed
\end{frame}
