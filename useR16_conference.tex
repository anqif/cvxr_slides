...
\begin{frame}{Direct Standardization}
	...
	\BIT
		...
		\item Want to predict probability $p \in \reals^n$ for all samples
	...
	\item $(y,p)$ is a guess of true response distribution
	\EIT
\end{frame}
...
\begin{frame}[fragile]{Direct Standardization}
	...
	\BIT
		\item \verb|Entr| is elementwise entropy function
		\item TODO: Details about code, constraint on fraction of women
	\EIT
\end{frame}

\begin{frame}{True vs. Uniform Distribution}
	TODO: Plot of CDF from original and skewed
\end{frame}

\begin{frame}{True vs. Estimated Distribution}
