...
\begin{frame}{True vs. Sample Probability Distribution}
	\vfill
	\begin{figure}
		\includegraphics[width=1\textwidth]{figs/dstand_pdf1.png}
	\end{figure}
	\vfill
\end{frame}
\fi
...
\iffalse
\begin{frame}{True vs. Estimated Probability Distribution}
	\vfill
	\begin{figure}
		\includegraphics[width=1\textwidth]{figs/dstand_pdf2.png}
	\end{figure}
	\vfill
\end{frame}
\fi
